...
pub = rospy.Publisher('plain2base_link', Float64, queue_size=10)
...
link1.link_name = 'omni_robot::base_footprint'  # 替换为你的link名称

link2 = GetLinkStateRequest()
link2.link_name = 'omni_robot::front_plain_link'  # 替换为你的link名称
